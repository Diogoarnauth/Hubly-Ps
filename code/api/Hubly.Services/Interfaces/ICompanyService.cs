...
namespace Hubly.api.Services.Interfaces
{
    ...
    public interface ICompanyService
    {
        ...
        Task<OneOf<bool, CompanyError>> EditProfile(int user_id, int company_size, string company_name, string description, string sector, string website_link, string country_headquarters);
    }
