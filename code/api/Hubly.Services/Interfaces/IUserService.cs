...
namespace Hubly.api.Services.Interfaces
{
    ...
    public interface IUserService
    {
        ...
        Task<OneOf<User, UserError>> GetFullCreatorProfile(int targetCreatorId, int viewerId, int? coWorkerId);
        Task<OneOf<User, UserError>> GetFullCompanyProfile(int targetCompanyId, int viewerId, int? coWorkerId);
