...
"[project]/components/ToastImplementations.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/services/api/apiClient.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ToastImplementations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ToastImplementations.ts [app-client] (ecmascript)");
;
function isConflictResponse(obj) {
    return obj && typeof obj === 'object' && obj.status === 409 && typeof obj.message === 'string';
}
class ApiClient {
    baseHeaders;
    static unauthorizedHandler = null;
    constructor(){
        this.baseHeaders = {
    ...
    static setUnauthorizedHandler(handler) {
        ...
        try {
            ...
            if (response.status === 409) {
                const errorData = await response.json().catch(()=>({
                        message: 'Failed to parse conflict response'
                    }));
            ...
            if (!response.ok) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ToastImplementations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])(`Error ${response.status}`, errorData.message || 'An error occurred during the request');
                return null;
            }
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ToastImplementations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])('Request Failed', error instanceof Error ? error.message : 'Unknown error occurred');
            return null;
        }
    }
    async get(url) {
...
"[project]/components/AuthRedirectHandler.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/api/apiClient.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
...
function AuthRedirectHandler() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthRedirectHandler.useEffect": ()=>{
            const handleUnauthorized = {
                "AuthRedirectHandler.useEffect.handleUnauthorized": ()=>{
                    router.push('/login');
                }
            }["AuthRedirectHandler.useEffect.handleUnauthorized"];
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiClient"].setUnauthorizedHandler(handleUnauthorized);
        }
    }["AuthRedirectHandler.useEffect"], [
        router
    ]);
...
_s(AuthRedirectHandler, "vQduR7x+OPXj6PSmJyFnf+hU7bg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = AuthRedirectHandler;
var _c;
__turbopack_context__.k.register(_c, "AuthRedirectHandler");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_bf8782e1._.js.map